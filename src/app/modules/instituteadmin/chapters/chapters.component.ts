...
export class ChaptersComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.gradeName = this.route.snapshot.paramMap.get('gname');
        this.subjectName = this.route.snapshot.paramMap.get('sname');
        this.getAllPhases();
        ...
        this.titleService.setBreadcrumb([
            ...
            },
            {
                ...
                url: `curriculum/${this.gradeId}/${this.gradeName}/subjects`,
            },
    ...
    onChapterExpand(chapter: IChapters): void {
